...
generate_button = tk.Button(root, text='Generar', command=lambda: generate_password(length_entry.get()))
...
# Asociar el menú contextual personalizado con el evento <Button-2> para macOS y <Button-3> para otros sistemas
password_text.bind('<Button-2>', show_context_menu)  # macOS puede usar <Button-2> para clic derecho
password_text.bind('<Button-3>', show_context_menu)  # Otros sistemas usan <Button-3> para clic derecho
